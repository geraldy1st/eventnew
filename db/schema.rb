...
ActiveRecord::Schema.define(version: 2018_05_08_201958) do
  ...
  create_table "connects", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "nickname"
    t.index ["email"], name: "index_connects_on_email", unique: true
    t.index ["reset_password_token"], name: "index_connects_on_reset_password_token", unique: true
  end
